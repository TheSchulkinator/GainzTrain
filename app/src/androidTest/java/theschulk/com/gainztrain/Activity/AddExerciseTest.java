...
public class AddExerciseTest {
    ...
    public void addExerciseTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.add_exercise_title), withText("Select an exercise"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                0),
                        isDisplayed()));
        textView.check(matches(withText("Select an exercise")));
        ...
        ViewInteraction button = onView(
                allOf(withId(R.id.send_exercise_button),
                        childAtPosition(
                                childAtPosition(
