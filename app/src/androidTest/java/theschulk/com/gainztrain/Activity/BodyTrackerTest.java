...
public class BodyTrackerTest {

    @Rule
    public ActivityTestRule<HomeActivity> mActivityTestRule = new ActivityTestRule<>(HomeActivity.class);

    @Test
    public void bodyTrackerTest() {
        try {
            Thread.sleep(5000);
        ...
        ViewInteraction appCompatTextView = onView(
                allOf(withId(R.id.title), withText("Body Tracker"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.body_tracker_title), withText("Body Tracker"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("Body Tracker")));
